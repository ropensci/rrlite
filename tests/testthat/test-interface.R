## NOTE: this is entirely copied over from redux@870830a with a couple of
## little tweaks.  Edit the file there once it's autogenerated.
context("interface")
...
test_that("SORT", {
  ...
  ## TODO: fix rlite so that this gives a redis status not a character.
